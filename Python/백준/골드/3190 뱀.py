...
class Main:
    ...
    def move_snake(self, y, x, direction, snake, grid):  # 뱀을 한 칸 이동시키고 종료 조건 체크
        ...
        # 머리 이동
        snake.append((my, mx))  # 문제의 설명을 그대로 재현하려면 사과가 있던 없던 머리를 먼저 움직여야 하지만, 중복이므로 묶음
        return my, mx
