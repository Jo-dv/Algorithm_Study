...
public class boj_2056 {
	...
	static int[] indgree;  // 진입차수를 저장할 배열
	static int[] time_table;  // 작업 시간을 저장할 배열
	static int[] cost;  // 업무들을 처리했을 소요된 총 작업 시간을 저장할 배열 
	static int time;  // 입력 중 시간을 저장할 변수
	static int work_num;  // 입력 중 선행 업무의 수를 저장할 변수
	static int previous;  // 이전 업무 노드를 저장할 변수
	static int answer = 0;
